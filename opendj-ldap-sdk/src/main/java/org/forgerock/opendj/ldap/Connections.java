...
public final class Connections
{
   ...
   * for a long time and which have been remotely closed due to a time out will
   * never be returned. However, once a pooled connection has been obtained it
   * is the responsibility of the calling application to handle subsequent
   * connection failures, these being signaled via a {@link ConnectionException}.
   *
   * @param factory
