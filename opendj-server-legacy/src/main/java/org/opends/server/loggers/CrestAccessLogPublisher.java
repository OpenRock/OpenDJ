 ...
 */
public final class CrestAccessLogPublisher extends AbstractTextAccessLogPublisher<FileBasedAccessLogPublisherCfg>
    implements ConfigurationChangeListener<FileBasedAccessLogPublisherCfg>
{
      ...
      throws ConfigException, InitializationException
  {
    ...
    try
    {
      ConnectionFactory connectionFactory = CrestAuditLogPublisher.getAuditInternalConnectionFactory();
   ...
   */
  @Override
  public ConfigChangeResult applyConfigurationChange(final FileBasedAccessLogPublisherCfg config)
  {
   ...
   */
  @Override
  public boolean isConfigurationAcceptable(final FileBasedAccessLogPublisherCfg configuration,
   ...
   */
  @Override
  public boolean isConfigurationChangeAcceptable(final FileBasedAccessLogPublisherCfg config,
      final List<LocalizableMessage> unacceptableReasons)
  {
    return true;
  }
  ...
  private void appendExtendedRequest(final ExtendedOperation extendedOperation, final StringBuilder buffer)
  {
   ...
   */
  private void appendHeader(final Operation operation, final String opType, final String category,
  ...
  private void appendModifyDNRequest(final ModifyDNOperation modifyDNOperation, final StringBuilder buffer)
  {
