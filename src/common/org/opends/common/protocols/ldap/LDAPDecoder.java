...
public class LDAPDecoder
{
   ...
   * @param handler The <code>LDAPMessageHandler</code> that will
   ...
   *
   * @param  reader The ASN.1 reader.
   * @param  rawMessage The decoded message to decode controls for.
   *
   * @throws  LDAPException  If a problem occurs while attempting to decode the
   *                         controls.
   */
  private static void decodeControls(ASN1Reader reader, RawMessage rawMessage)
      throws LDAPException
  {
    try
    {
   ...
   */
  private static void decodeControl(ASN1Reader reader, RawMessage rawMessage)
      throws LDAPException
  {
    try
    {
   ...
   *
   * @param  reader The ASN.1 reader.
   * @param  messageID The decoded message ID for this message.
   * @param  handler The <code>LDAPMessageHandler</code> that will
   *                 handle this decoded message.
   *
      ...
      throws LDAPException
  {
    ...
    catch (Exception e)
    {
      ...
      Message message =
          ERR_LDAP_BIND_RESULT_DECODE_SERVER_SASL_CREDENTIALS.get(
              String.valueOf(e));
      throw new LDAPException(PROTOCOL_ERROR, message, e);
    }
      ...
      throws LDAPException
  {
    ...
    RawCompareRequest rawMessage = new RawCompareRequest(dn, attributeType,
        assertionValue);
    decodeControls(reader, rawMessage);
    handler.handleRequest(messageID, rawMessage);
  }
      ...
      throws LDAPException
  {
    ...
    try
    {
      rawMessage = new RawDeleteRequest(reader.readOctetStringAsString());
    }
    catch (Exception e)
    {
      if (debugEnabled())
      ...
      throws LDAPException
  {
    ...
    RawExtendedResponse rawMessage =
        new RawExtendedResponse(resultCode, matchedDN, diagnosticMessage);
      ...
      throws LDAPException
  {
    ...
    catch (Exception e)
    {
      ...
      Message message =
          ERR_LDAP_INTERMEDIATE_RESPONSE_CANNOT_DECODE_VALUE.get(
              String.valueOf(e));
      throw new LDAPException(PROTOCOL_ERROR, message, e);
    }
      ...
      throws LDAPException
  {
    ...
    RawModifyDNRequest rawMessage = new RawModifyDNRequest(entryDN, newRDN);
    try
    {
      ...
      throws LDAPException
  {
    ...
    RawModifyDNResponse rawMessage =
        new RawModifyDNResponse(resultCode, matchedDN, diagnosticMessage);
      ...
      throws LDAPException
  {
    ...
    RawSearchResultDone rawMessage =
        new RawSearchResultDone(resultCode, matchedDN, diagnosticMessage);
   ...
   *                         protocol op.
   */
  public static void decodeSearchEntry(ASN1Reader reader,
                                       int messageID,
                                       LDAPMessageHandler handler)
      throws LDAPException
  {
