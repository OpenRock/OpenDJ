 ...
 */
public final class EqualFilter extends AssertionFilter
{
  public EqualFilter(String attributeDescription,
                        ByteString assertionValue)
  {
    super(attributeDescription, assertionValue);
  }

  public EqualFilter(AttributeDescription attributeDescription,
                        ByteString assertionValue)
  {
  ...
  {
    buffer.append("EqualityFilter(attributeDescription=");
