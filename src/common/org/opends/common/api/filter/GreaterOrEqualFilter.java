 ...
 */
public final class GreaterOrEqualFilter extends AssertionFilter
{
  public GreaterOrEqualFilter(String attributeDescription,
                                 ByteString assertionValue)
  {
    super(attributeDescription, assertionValue);
  }

  public GreaterOrEqualFilter(AttributeDescription attributeDescription,
                        ByteString assertionValue)
  {
