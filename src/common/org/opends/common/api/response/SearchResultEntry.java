 ...
 */
public final class SearchResultEntry extends Message
    implements Response
{
  private String dn;
  ...
  public SearchResultEntry(DN dn, org.opends.server.types.Attribute... attributes)
  {
    Validator.ensureNotNull(dn);
    this.dn = dn.toString();
  ...
  public SearchResultEntry(Entry entry)
  {
    ...
    this.attributes =
          new ArrayList<Attribute>(entry.attributeCount());
                                    ...
                                    ByteString... attributeValues)
  {
    ...
    attributes.add(new Attribute(attributeDescription,
        attributeValues));
    return this;
  }

  public SearchResultEntry addAttribute(org.opends.server.types.Attribute... attributes)
  {
    if(attributes == null)
    {
      return this;
