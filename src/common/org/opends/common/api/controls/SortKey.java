 ...
 * indicates whether the sort should be ascending or descending.
 * It may also contain a specific ordering matching rule that should
 * be used for the sorting process, although if none is provided it
 * will use the default ordering matching rule for the attribute type.
 */
