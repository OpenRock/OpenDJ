...
public class ServerSideSortControl
{
  ...
  public static class Request extends Control
  {
    ...
    public Request(String sortOrderString)
  ...
  public static class Response extends Control
  {
    ...
    public Response setAttributeDescription(
        String attributeDescription)
    {
      this.attributeDescription = attributeDescription;
      return this;
      ...
      implements ControlDecoder<Request>
  {
     ...
     * {@inheritDoc}
     */
    public Request decode(boolean isCritical,
                          ByteString value)
        throws DecodeException
    {
      if (value == null)
      ...
      try
      {
        ...
        while(reader.hasNextElement())
        {
          ...
          request.addSortKey(
              new SortKey(attrName, orderingRule, reverseOrder));
        }
        reader.readEndSequence();
