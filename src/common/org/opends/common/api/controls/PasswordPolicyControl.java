...
public class PasswordPolicyControl
{
  ...
  public static class Response extends Control
  {
    ...
    public ByteString getValue() {
      ...
      try
      {
        ...
        if (errorType != null)
        {
          writer.writeInteger(TYPE_ERROR_ELEMENT,
              errorType.intValue());
        }
        writer.writeEndSequence();
    ...
    public Response setWarning(PasswordPolicyWarningType type,
                               int value)
    {
      ...
      implements ControlDecoder<Response>
  {
     ...
     * {@inheritDoc}
     */
    public Response decode(boolean isCritical,
                           ByteString value)
        throws DecodeException
    {
      if (value == null)
      ...
      try
      {
            ...
            reader.peekType() == TYPE_WARNING_ELEMENT)
        {
          ...
          reader.readStartSequence();
          warningType =
              PasswordPolicyWarningType.valueOf(
                  0x7F & reader.peekType());
