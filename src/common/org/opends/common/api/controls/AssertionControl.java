...
/**
  ...
  private final static class Decoder
      implements ControlDecoder<AssertionControl>
  {
    /**
     * {@inheritDoc}
     */
    public AssertionControl decode(boolean isCritical,
                                              ByteString value)
        throws DecodeException
    {
      ...
      catch (IOException e)
      {
        throw new DecodeException(
            ERR_LDAPASSERT_INVALID_CONTROL_VALUE.get(
