...
public class VLVControl
{
  ...
  public static class Request extends Control
  {
    ...
    /**
     * Creates a new VLV request control that will identify the
     *  target entry by offset.
     *
    ...
    {
      this(isCritical, beforeCount, afterCount,
          VLVTarget.byOffset(offset, contentCount), contextID);
    }
     ...
     *                             assertion value.
     * @param  assertionValue      The greaterThanOrEqual target assertion value
     *                             that indicates where to start the page of
     *                             results.
    ...
    {
      this(isCritical, beforeCount, afterCount,
          VLVTarget.greaterThanOrEqual(assertionValue), contextID);
    }


    private Request(boolean isCritical, int beforeCount, int afterCount,
                    VLVTarget target, ByteString contextID)
    {
  ...
  public static class Response extends Control
  {
     ...
     * @param  vlvResult   The result code for the VLV operation.
     */
    ...
    public Response(boolean isCritical, int targetPosition,
                    int contentCount, VLVResult vlvResult,
                    ByteString contextID)
    {
      ...
      implements ControlDecoder<Request>
  {
        ...
        throws DecodeException
    {
      ...
      try
      {
        ...
        return new Request(isCritical, beforeCount, afterCount,
            target, contextID);
      }
      catch (IOException e)
      {
      ...
      implements ControlDecoder<Response>
  {
        ...
        throws DecodeException
    {
      ...
      try
      {
        ...
        return new Response(isCritical, targetPosition,
            contentCount, vlvResult, contextID);
      }
      catch (IOException e)
      {
        Message message =
