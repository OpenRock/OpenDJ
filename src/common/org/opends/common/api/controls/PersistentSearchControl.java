...
public class PersistentSearchControl extends Control
{
   ...
   *                      notification control in updated entries that match the
   *                      associated search criteria.
   * @param  changeTypes  The change types for which to provide
   *                      notification to the client.
   */
  public PersistentSearchControl(
  ...
  private PersistentSearchControl(boolean isCritical,
                                  int changeTypes,
                                  boolean changesOnly,
                                  boolean returnECs)
  {
  ...
  /**
   * Indicates if the change type is included in this persistent
   * search control.
   *
   * @param type The change type whose presence is to be tested.
  ...
  public void toString(StringBuilder buffer)
  {
    ...
    boolean comma = false;
    for(PersistentSearchChangeType type :
