 ...
 */
public class RawUnknownFilter extends RawFilter
{
  private byte filterTag;
  private ByteString filterBytes;

  public RawUnknownFilter(byte filterTag, ByteString filterBytes)
  {
  ...
  public RawUnknownFilter setFilterTag(byte filterTag)
  {
  ...
  public RawUnknownFilter setFilterBytes(ByteString filterBytes)
  {
