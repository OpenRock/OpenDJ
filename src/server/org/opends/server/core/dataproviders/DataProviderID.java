 ...
 * <ul>
 * <li><b>User configured</b>: these are data providers which have been
 * defined using the server's configuration.
...
public final class DataProviderID implements Comparable<DataProviderID>
{
  ...
  {
    this.name = name;
    this.normalizedName = toLowerCase(name.trim());
  ...
  /**
   * Returns the data provider name associated with this data provider
   * ID.
   *
   * @return The data provider name associated with this data provider
   *         ID.
   */
  ...
  /**
   * Indicating whether or not this ID represents an internal data
   * provider.
   *
