...
/**
 * The status of a data provider. A data provider may be enabled,
 * disabled, or providing a restricted service.
 */
public enum DataProviderStatus
{
  ...
  /**
   * The data provider is only accepting read operations; all write
   ...
   *          The human-readable name for this status.
   */
  private DataProviderStatus(String name)
  {
    this.name = name;
  }
