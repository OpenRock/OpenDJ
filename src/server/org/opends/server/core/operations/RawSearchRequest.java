...
public final class RawSearchRequest extends RawRequest
{
  ...
  /**
   * Returns a decoded search request representing this raw search
   * request. Subsequent changes to this raw search request will not be
   * reflected in the returned search request.
   *
   * @return A decoded search request representing this raw search
   *         request.
   * @throws DirectoryException
   *           If this raw search request could not be decoded.
   */
  @Override
  public SearchRequest toRequest() throws DirectoryException
  {
