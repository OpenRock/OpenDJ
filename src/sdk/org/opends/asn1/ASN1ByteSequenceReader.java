...
import static org.opends.messages.ProtocolMessages.ERR_ASN1_SEQUENCE_SET_TRUNCATED_VALUE;
...
final class ASN1ByteSequenceReader extends AbstractASN1Reader
{
  ...
  public void readStartSequence() throws IOException
  {
    ...
    ByteSequenceReader subByteString =
        reader.getByteSequence(peekLength).asReader();
