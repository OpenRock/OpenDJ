...
/**
 * Thrown to indicate that a connection factory could not be initialized
 * due to a problem with its configuration options.
 */
    ...
    implements LocalizableException
{
   ...
   */
  public InitializationException(Message message, Throwable cause)
  {
