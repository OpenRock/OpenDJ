...
public class Utils
{
   ...
   * @throws org.opends.sdk.DecodeException If an error occurs.
   */
      ...
      throws DecodeException
  {
    ...
    if(idx == -1)
    {
      ...
      } else
      {
        ...
        throw new DecodeException(
            Message.raw("Invalid format for criticality value:" + remainder));
      }
    ...
    } else
    {
      // TODO: I18N
      throw new DecodeException(
          Message.raw("Invalid format for criticality value:" + critical));
    ...
    return new GenericControl(controlOID, controlCriticality, controlValue);
  }
