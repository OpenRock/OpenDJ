...
public class LDAPModify extends ConsoleApplication
{
  ...
  {
    int retCode = mainModify(args, false, System.in, System.out, System.err);
  ...
  {
    return mainModify(args, true, System.in, System.out, System.err);
  }
  ...
  {
    return mainModify(args, true, inStream, outStream, errStream);
  }
  ...
  private int run(String[] args, boolean returnMatchingEntries)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        {
          if(!cr.accept(visitor, null) && !continueOnError.isPresent())
          {
            break;
          }
        }
  ...
  private class VisitorImpl
      implements ChangeRecordVisitor<Boolean, java.lang.Void>
  {
    ...
    public Boolean visitChangeRecord(Void aVoid, AddRequest change)
    {
    ...
    public Boolean visitChangeRecord(Void aVoid, DeleteRequest change)
    {
      for(Control control : controls)
      {
        change.addControl(control);
    ...
    public Boolean visitChangeRecord(Void aVoid, ModifyDNRequest change)
    {
      for(Control control : controls)
      {
        change.addControl(control);
    ...
    public Boolean visitChangeRecord(Void aVoid, ModifyRequest change)
    {
      for(Control control : controls)
      {
        change.addControl(control);
