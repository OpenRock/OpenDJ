...
public class SearchRate extends ConsoleApplication
{
  ...
  private class SearchPerformanceRunner extends PerformanceRunner
  {
    ...
    private class SearchStatsHandler
        extends UpdateStatsResultHandler<SearchResult>
    ...
    private class SearchWorkerThread
        extends WorkerThread<SearchResultHandler>
    {
      private SearchRequest sr;
      private Object[] data;

      private SearchWorkerThread(Connection connection,
                                 ConnectionFactory connectionFactory)
      {
        super(connection, connectionFactory);
      }

      public SearchResultHandler getHandler(long startTime)
      {
